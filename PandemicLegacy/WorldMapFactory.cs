...
namespace PandemicLegacy
{
    public class WorldMapFactory
    {
        public WorldMap BuildMap()
        {
            ...
            mapCities[City.BuenosAires].AddConnectedCities(mapCities[City.Bogota], mapCities[City.SaoPaulo]);
            ...
            mapCities[City.Chennai].AddConnectedCities(mapCities[City.Bangkok], mapCities[City.Delhi], mapCities[City.Jakarta], mapCities[City.Kolkata], mapCities[City.Mumbai]);
            ...
            mapCities[City.Khartoum].AddConnectedCities(mapCities[City.Cairo], mapCities[City.Johannesburg], mapCities[City.Kinshasa], mapCities[City.Lagos]);
