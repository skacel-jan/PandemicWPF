...
namespace Game.Pandemic.GameLogic.Board
{
    public class MapCity : ObservableObject
    {
        ...
        public bool HasResearchStation
        {
            ...
            set => SetProperty(ref _hasResearchStation, value);
        }
            ...
            if (Infections[color] != newInfection)
            {
                ...
                switch (color)
                {
                    case DiseaseColor.Black:
                        OnPropertyChanged(nameof(BlackInfection));
                        break;

                    case DiseaseColor.Blue:
                        OnPropertyChanged(nameof(BlueInfection));
                        break;

                    case DiseaseColor.Red:
                        OnPropertyChanged(nameof(RedInfection));
                        break;

                    case DiseaseColor.Yellow:
                        OnPropertyChanged(nameof(YellowInfection));
                        break;
                }
            }
