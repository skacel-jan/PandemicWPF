...
namespace Game.Pandemic.ViewModels
{
    public class BoardViewModel : ViewModelBase
    {
        ...
        public BoardViewModel(GameFactory gameFactory, IDialogService dialogService)
        {
            ...
            Game.SelectionService.BoardViewModel = this;
        ...
        public IList<Tuple<RelayCommand, IGameAction>> Actions { get => _actions; private set => SetProperty(ref _actions, value); }
        ...
        public ViewModelBase ActionViewModel
        {
            ...
            set
            {
                SetProperty(ref _actionViewModel, value);
        ...
        public void SetNextCharacter()
        {
            Actions = _currentCharacter.Actions.Select(a =>
                (new RelayCommand(() => DoAction(a.Value), () => IsActionPhase && CanExecuteAction(a.Value)),
                 _currentCharacter.Actions[a.Key]).ToTuple()).ToList();
        }

        public RelayCommand EventsCommand { get; }

        public GameLogic.Game Game { get; }
        ...
        public ViewModelBase InfoViewModel
        {
            ...
            set
            {
                SetProperty(ref _infoViewModel, value);
        ...
        public bool IsPlayerHandVisible
        {
            ...
            set { SetProperty(ref _isPlayerHandVisible, value); }
        }
        ...
        public void RefreshAllCommands()
        {
            ...
            {
                action.Item1.NotifyCanExecuteChanged();
            }
            EventsCommand.NotifyCanExecuteChanged();
        ...
        private void PlayEvent(object sender, EventSelectedEventArgs e)
        {
            ActionViewModel = null;
            var eventAction = e.EventCard.GetEventAction(Game);
            Game.ResolveAction(eventAction);
        }
